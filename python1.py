...
def one(input1, input2):
	#input1 = str(input"your word here "):
	#input2 = str(input"your word here "):
	return ""
...
#def names = list1("bertclivebert", "xxbertfridgebertyy", "xxBertfridgebERtyy")
#	names = list1.lower()
#	names = names.split()
#	list1.seek(len("bert")):
#		return list1(-"")
...
#or
#num = int(input ("add your number here:"))
 #       return "fizz" if num % 3 == 0:
  #      return "buzz" if num 5 == 0:
   #     return "fizzbuzz" if num % 5 == 0 and number % 5 == 0:
   # else: 
	#    return "null"
...
def mnemonic(vowel):
 #for vowel in range of (a,b,c...)
  #if vowel [position in a-z] > c [position in a-z]:
   # return True
 # else:
	return False
...
def funcnum(self, parameter_list):
	#funcnum = ("int("input a number between 1 and 10 here:"))
#for funcnum in range (0,9):
	#print (num * [] - num)
	return ""
